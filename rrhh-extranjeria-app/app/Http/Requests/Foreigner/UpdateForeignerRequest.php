...
class UpdateForeignerRequest extends FormRequest
{
    ...
    {
        $foreignerId = $this->route('foreigner');

        return [
            // Foreigner main data
            'first_name' => ['required', 'string', 'max:50'],
            'last_name' => ['required', 'string', 'max:100'],
            'passport' => ['required', 'string', 'max:44', Rule::unique('foreigners')->ignore($foreignerId)],
            'nie' => ['required', 'string', 'size:9', Rule::unique('foreigners')->ignore($foreignerId)],
            'niss' => ['nullable', 'string', 'size:12', Rule::unique('foreigners')->ignore($foreignerId)],
