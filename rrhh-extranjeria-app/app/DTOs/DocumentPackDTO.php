...
class DocumentPackDTO
{
    ...
    public function getWorkerData(): array
    {
        ...
        return [
            ...
            'trabajador_telefono' => $extraData?->phone ?? '',
            'trabajador_email' => $extraData?->email ?? '',
    ...
    public function getEmployerData(): array
    {
        ...
        $data = [
            ...
            'nif' => $employer->nif,
            'ccc' => $employer->ccc,
            'cnae' => $employer->cnae?->value ?? '',
            'cnae_actividad' => $employer->cnae?->label() ?? '',
            'forma_juridica' => $employer->legal_form->value,
            'empleador_email' => $employer->email ?? '',
            'empleador_telefono' => $employer->phone ?? '',
